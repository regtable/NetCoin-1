The following is a list of assets used in the netcoin source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://netcointalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original netcoin logo from Bitboy)
* License: MIT
