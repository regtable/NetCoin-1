...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: netcoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: netcoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 34695 or testnet: 44695)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 34696 or testnet: 44696)") + "\n";
    ...
    strUsage += "\n" + _("SSL options: (see the NetCoin Wiki for SSL setup instructions)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. NetCoin is probably already running."), strDataDir.c_str()));
